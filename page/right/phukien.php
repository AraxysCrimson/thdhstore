...
$sql_pro = "SELECT * FROM tbl_sanpham WHERE 
            tensanpham LIKE '%đồng%' 
            OR tensanpham LIKE '%nhẫn%' 
            OR tensanpham LIKE '%vòng%' 
            ORDER BY id_sanpham DESC LIMIT $begin, $limit";
...
<div class="content">
    <h2 class="section-title">👜 DANH MỤC PHỤ KIỆN 👜</h2>
