...
$sql_pro = "SELECT * FROM tbl_sanpham ORDER BY id_sanpham DESC LIMIT $begin, $limit";
...
<div class="content">
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <?php if ($page > 1) { ?>
                <li class="page-item">
                    <a class="page-link" href="?trang=<?php echo ($page - 1); ?>" aria-label="Previous">
            ...
            <?php if ($page < $total_pages) { ?>
                <li class="page-item">
                    <a class="page-link" href="?trang=<?php echo ($page + 1); ?>" aria-label="Next">
